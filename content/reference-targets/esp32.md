...
- ESP32_PSRAM_REV0 that _fits_ all ESP32 boards carrying an ESP32 chip _with_ PSRAM support. These can be ESP32-DevKitC, ESP32-WROOM and ESP32-WROVER variants _with_ PSRAM.
- ESP32_REV0 that _fits_ all ESP32 boards carrying an ESP32 chip _without_ PSRAM support. These can be ESP32-DevKitC, ESP32-WROOM and ESP32-WROVER variants _without_ PSRAM.
...
- ESP32_PSRAM_REV3 that _fits_ all ESP32 boards carrying an ESP32 chip **revision 3** _with_ PSRAM support.
