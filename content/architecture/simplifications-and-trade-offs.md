...
Oversimplifying `enums` are special classes which basically contain fields which are constants.
...
Note that these could be made available, at the expense of increasing the PE size.
