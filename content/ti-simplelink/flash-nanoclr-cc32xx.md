...
1. Click the **Start** button there and select the project corresponding to your board. This is assuming that you've created that project beforehand. If that's not the case, please follow the walk-through in the [prepare a uniflash project section](#prepare-a-uniflash-project-for-a-cc32xx-board).
