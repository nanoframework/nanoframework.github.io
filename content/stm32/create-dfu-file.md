...
- Locate the devices Device_BlockStorage.c file.
  - E.g. the Netduino 3 file is located in the [nf-Community-Targets repository](https://github.com/nanoframework/nf-Community-Targets/blob/main/ChibiOS/NETDUINO3_WIFI/common/Device_BlockStorage.c).
